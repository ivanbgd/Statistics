#define NORMAL_DISTRIBUTION_SEQ
#ifdef NORMAL_DISTRIBUTION_SEQ

/*** Generating Normal (Gaussian) distribution, sequentially ***/
...
/* Number of samples in an array */
#define NUM_SAMPLES 1000u

/* Number of loops for time measurement */
...
int main(int argc, char *argv[]) {
    ...
    /* Desired mean (mu) and standard deviation (sigma) */
